...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/billing/subscription/activate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/business/settings": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Business settings payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/business/whatsapp": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Business WhatsApp payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/internal/wa-templates": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/routes.InternalWATemplateListResponseDoc"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "WA template payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.InternalWATemplateCreateRequestDoc"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/routes.InternalWATemplateCreateResponseDoc"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/internal/wa-templates/variables": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/routes.InternalWATemplateVariableOptionsResponseDoc"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/routes.InternalWATemplateGetResponseDoc"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.InternalWATemplateUpdateRequestDoc"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "routes.InternalWATemplateBodyExamplePreviewItemDoc": {
            "type": "object",
            "properties": {
                "key": {
                    "type": "string",
        ...
        "routes.InternalWATemplateCreateRequestDoc": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string",
                ...
                "metaTemplateName": {
                    "type": "string",
                    "example": "facial_treatment_testing"
                },
                "status": {
                    "type": "string",
                    "example": "PENDING"
                ...
                "templateAlias": {
                    "type": "string",
                    "example": "Facial Reminder"
                }
            }
        },
        "routes.InternalWATemplateCreateResponseDoc": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "object",
        ...
        "routes.InternalWATemplateGetResponseDoc": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/routes.InternalWATemplateItemDoc"
                },
                "error": {
                    "type": "boolean",
                    "example": false
        ...
        "routes.InternalWATemplateItemDoc": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string",
                ...
                "bodyExamplePreview": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/routes.InternalWATemplateBodyExamplePreviewItemDoc"
                    }
                },
                "category": {
                    "type": "string",
        ...
        "routes.InternalWATemplateListResponseDoc": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "routes.InternalWATemplateUpdateRequestDoc": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string",
                    "example": "Halo {{1}}! Ini template update."
                },
                "bodyExample": {
                    "type": "array",
                    "items": {
                ...
                "metaTemplateName": {
                    "type": "string",
                    "example": "facial_treatment_testing_v2"
                },
                "status": {
                    "type": "string",
                    "example": "APPROVED"
                ...
                "templateAlias": {
                    "type": "string",
                    "example": "Facial Reminder V2"
                }
            }
        },
        "routes.InternalWATemplateVariableOptionDoc": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Nama customer/pelanggan."
                },
                "key": {
                    "type": "string",
                    "example": "customer_name"
        ...
        "routes.InternalWATemplateVariableOptionsResponseDoc": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/routes.InternalWATemplateVariableOptionDoc"
                    }
                },
                "error": {
                    "type": "boolean",
